...
Grab the [frontmatter example code from above](#i-want-to-add-or-edit-structurally-complex-page) and add that to your page, checking there's no blank lines or spaces before the first `---`.
